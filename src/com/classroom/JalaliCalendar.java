...
public class JalaliCalendar extends Calendar {
    private static int gregorianDaysInMonth[] = {31, 28, 31, 30, 31,
            30, 31, 31, 30, 31, 30, 31};
    private static int jalaliDaysInMonth[] = {31, 31, 31, 31, 31, 31,
            30, 30, 30, 30, 30, 29};
    ...
    public static class YearMonthDate {
        ...
        public YearMonthDate(Date date1) {
        ...
        public Calendar toCalendar() {
            return new GregorianCalendar(getYear(), getMonth(), getDate());
        }
